...
ShakeMap originated primarily as an internet-based system as a
real-time display of earthquake shaking.
...
In this User's Guide, after some background, we present the range ShakeMap
products and describe the available formats. The different automated mechanisms
to receive and utilize ShakeMap, including GIS Web Services and GeoJSON feeds,
and via ShakeCast are described and links are provided. Many users also
...
systems of DYFI, ShakeCast and PAGER. Lastly, and importantly, are :ref:`sec_disclaimers`
...
.. toctree::
   ...
   background.rst
   products.rst
   shakemap_archives.rst
   shakemap_applications.rst
   related_systems.rst
   disclaimers.rst
